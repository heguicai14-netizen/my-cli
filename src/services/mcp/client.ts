...
import { markClaudeAiMcpConnected } from './mycliai.js'
...
import { isClaudeInChromeMCPServer } from '../../utils/mycliInChrome/common.js'
...
const claudeInChromeToolRendering =
  (): typeof import('../../utils/mycliInChrome/toolRendering.js') =>
    require('../../utils/mycliInChrome/toolRendering.js')
    ...
    try {
      ...
      if (serverRef.type === 'sse') {
        ...
        const { createChromeContext } = await import(
          '../../utils/mycliInChrome/mcpServer.js'
        )
