...
/**
 * Loads markdown files from .mycli/output-styles directories throughout the project
 * and from ~/.mycli/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .mycli/output-styles/*.md -> project styles
 * - User ~/.mycli/output-styles/*.md -> user styles (overridden by project styles)
 *
