...
export function MemoryStep() {
  ...
  if ($[1] !== isUserScope) {
    t1 = isUserScope ? [{
      label: "User scope (~/.mycli/agent-memory/) (Recommended)",
      value: "user"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "Project scope (.mycli/agent-memory/)",
      value: "project"
    }, {
      label: "Local scope (.mycli/agent-memory-local/)",
      value: "local"
    }] : [{
      label: "Project scope (.mycli/agent-memory/) (Recommended)",
      value: "project"
    }, {
      label: "None (no persistent memory)",
      value: "none"
    }, {
      label: "User scope (~/.mycli/agent-memory/)",
      value: "user"
    }, {
      label: "Local scope (.mycli/agent-memory-local/)",
      value: "local"
