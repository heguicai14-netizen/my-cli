...
import { queryModelWithoutStreaming } from '../../services/api/mycli.js'
...
export async function applySkillImprovement(
  ...
  // Skills live at .mycli/skills/<name>/SKILL.md relative to CWD
  const filePath = join(getCwd(), '.mycli', 'skills', skillName, 'SKILL.md')
