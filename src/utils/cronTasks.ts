// Scheduled prompts, stored in <project>/.mycli/scheduled_tasks.json.
//
...
const CRON_FILE_REL = join('.mycli', 'scheduled_tasks.json')
...
/**
 * Read and parse .mycli/scheduled_tasks.json. Returns an empty task list if the file
...
/**
 * Overwrite .mycli/scheduled_tasks.json with the given tasks. Creates .mycli/ if
 ...
 * written to .mycli/scheduled_tasks.json and dies with the process. The
