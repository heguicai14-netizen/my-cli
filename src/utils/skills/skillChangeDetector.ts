...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.mycli/skills)
  ...
  // User commands directory (~/.mycli/commands)
  ...
  // Project skills directory (.mycli/skills)
  ...
  // Project commands directory (.mycli/commands)
  ...
  for (const dir of getAdditionalDirectoriesForClaudeMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.mycli', 'skills')
    try {
