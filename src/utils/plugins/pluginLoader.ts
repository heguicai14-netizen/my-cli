 ...
 * Format: ~/.mycli/plugins/cache/{marketplace}/{plugin}/{version}/
 *
 * @param pluginId - Plugin identifier in format "name@marketplace"
 * @param version - Version string (semver, git SHA, etc.)
 ...
 * Format: ~/.mycli/plugins/cache/{plugin-name}/
 *
 ...
 * @param source - Source description for default manifest (e.g., "git:repo" or ".mycli-plugin/name")
 ...
 * @param source - Source identifier (e.g., "git:repo", ".mycli-plugin/my-plugin")
...
export async function createPluginFromPath(
  ...
  const manifestPath = join(pluginPath, '.mycli-plugin', 'plugin.json')
  ...
  const plugin: LoadedPlugin = {
    ...
    source, // Source identifier (e.g., "git:repo" or ".mycli-plugin/name")
 ...
 * - After modifying .mycli-plugin/ directory (for export)
