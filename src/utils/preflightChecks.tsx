...
async function checkEndpoints(): Promise<PreflightCheckResult> {
  // Preflight connectivity check removed — it was hardcoded to ping
  // platform.claude.com, which is wrong when settings.baseUrl points at a
  // different backend. Any real connectivity issue will surface on the first
  // API call anyway.
  return { success: true };
}
