...
/**
 * Detects if a file path is a session-related file under ~/.mycli.
 ...
 * Excludes: MYCLI.md, MYCLI.local.md, .mycli/rules/*.md (user-managed).
 *
...
// Excludes MYCLI.md, MYCLI.local.md, .mycli/rules/ (user-managed).
