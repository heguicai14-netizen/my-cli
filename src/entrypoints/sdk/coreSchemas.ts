  ...
  z
    .object({
      ...
      memory: z
        ...
        .optional()
        .describe(
          "Scope for auto-loading agent memory files. 'user' - ~/.mycli/agent-memory/<agentType>/, 'project' - .mycli/agent-memory/<agentType>/, 'local' - .mycli/agent-memory-local/<agentType>/",
        ),
      effort: z
  ...
  z
    ...
    .describe(
      'Source for loading filesystem-based settings. ' +
        "'user' - Global user settings (~/.mycli/settings.json). " +
        "'project' - Project settings (.mycli/settings.json). " +
        "'local' - Local settings (.mycli/settings.local.json).",
    ),
)
