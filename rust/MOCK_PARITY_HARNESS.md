...
This milestone adds a deterministic Anthropic-compatible mock service plus a reproducible CLI harness for the Rust `my-cli` binary.

## Artifacts

- `crates/mock-upstream-service/` — mock `/v1/messages` service
- `crates/my-cli/tests/mock_parity_harness.rs` — end-to-end clean-environment harness
